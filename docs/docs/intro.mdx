...
sidebar_position: 1
title: Welcome
description: LocoPilot is a local-first, OpenAI-compatible AI inference and fine-tuning platform. Run models locally, fall back to remote GPU, and train on your data — all from one CLI.
---
...
The CLI and local API live in [`locopilot-public-cli/src/`](https://github.com/locopilot/locopilot/tree/main/locopilot-public-cli/src):
