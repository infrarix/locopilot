...
Source: [`src/api/routes/models.ts`](https://github.com/locopilot/locopilot/blob/main/locopilot-public-cli/src/api/routes/models.ts)
...
:::note
The endpoint never errors out — Ollama failures and cloud failures both degrade silently to a partial list. Use [`/v1/locopilot/health`](health) when you need a true reachability signal.
:::
