...
Source: [`src/api/routes/health.ts`](https://github.com/locopilot/locopilot/blob/main/locopilot-public-cli/src/api/routes/health.ts)
...
- The [`locopilot doctor`](../cli/doctor) command uses this internally
