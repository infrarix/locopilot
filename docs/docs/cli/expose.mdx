...
Source: [`src/cli/commands/expose.ts`](https://github.com/locopilot/locopilot/blob/main/locopilot-public-cli/src/cli/commands/expose.ts)
...
3. Prints the public URL once it appears and saves it to `~/.locopilot/config.json` under `tunnel.url`.
