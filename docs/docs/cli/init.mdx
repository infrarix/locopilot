---
sidebar_position: 1
title: locopilot init
description: One-time setup — installs Ollama, verifies Python 3, creates the local SQLite database, and writes ~/.locopilot/.env.
---
...
Source: [`src/cli/commands/init.ts`](https://github.com/locopilot/locopilot/blob/main/locopilot-public-cli/src/cli/commands/init.ts)
