...
Source: [`src/training/types.ts`](https://github.com/quickslug/quickslug/blob/main/quickslug-public-cli/src/training/types.ts)
...
```bash
quickslug train --config train.json          # Free — local in-process
quickslug train --config train.json --cloud  # Pro  — QuickSlug Cloud
```

See [`quickslug train`](../cli/train) for the full command surface.
...
|---|---|---|
| `unsloth` | [`src/training/adapters/unsloth_runner.py`](https://github.com/quickslug/quickslug/blob/main/quickslug-public-cli/src/training/adapters/unsloth_runner.py) | Linux / Windows with NVIDIA GPU; ~2× faster than vanilla HF Trainer |
| `axolotl` | [`src/training/adapters/axolotl_runner.py`](https://github.com/quickslug/quickslug/blob/main/quickslug-public-cli/src/training/adapters/axolotl_runner.py) | More configuration knobs; multi-GPU |
| `mlx` | [`src/training/adapters/mlx_runner.py`](https://github.com/quickslug/quickslug/blob/main/quickslug-public-cli/src/training/adapters/mlx_runner.py) | Apple Silicon (auto-selected on `darwin/arm64`) |
