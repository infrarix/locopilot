...
sidebar_position: 3
title: Adapters
description: Unsloth, Axolotl, and MLX — the three training adapters QuickSlug ships with, and when to use each.
---

# Adapters

QuickSlug abstracts every training framework behind the `TrainingAdapter` interface:
...
Three adapters ship in [`src/training/adapters/`](https://github.com/quickslug/quickslug/tree/main/quickslug-public-cli/src/training/adapters):
...
} from '@infrarix/quickslug/training/types';
